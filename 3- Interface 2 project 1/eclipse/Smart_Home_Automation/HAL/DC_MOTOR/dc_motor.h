 ...
 *                                Definitions                                  *
 *******************************************************************************/
#define DC_MOTOR_PORT_ID		PORTB_ID	/* Configurable motor control port */
#define DC_MOTOR_PIN1_ID		PIN0_ID		/* Control pin for direction */
#define DC_MOTOR_PIN2_ID		PIN1_ID		/* Control pin for direction */
